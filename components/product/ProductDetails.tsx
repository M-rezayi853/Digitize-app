  ...
  return (
    <div className='px-4 flex flex-col items-center gap-y-9'>
      ...
      <div className='mb-6 text-center'>
        ...
        <h2 className='font-thin text-gray-500'>Apple iphone 13 256 GB</h2>
      </div>
      ...
      {/* seller detail */}
      <div className='text-slate-800 flex flex-wrap justify-center gap-x-2 md:gap-x-4 gap-y-5 text-sm'>
